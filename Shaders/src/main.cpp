...
/* The relative path to your shader may be different, depending on your
 * run time environment
 */
const string SHADER_PATH = "../src/";
...
void initShaders() {
    /* The path to the shader files depends on the runtime
     * environment.
     */
    vertex.load(SHADER_PATH + "vshader.vs", GL_VERTEX_SHADER);
    fragment.load(SHADER_PATH + "fshader.fs", GL_FRAGMENT_SHADER);
