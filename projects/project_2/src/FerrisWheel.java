...
public class FerrisWheel extends GLCanvas implements GLEventListener, KeyListener, MouseMotionListener, MouseWheelListener {
    /* SETTINGS */
    ...
    public FerrisWheel(GLCapabilities capabilities) {
        super(capabilities);
        glu = new GLU();
        setDefault();
